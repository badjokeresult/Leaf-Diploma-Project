...
mod consts {
    ...
    pub const MAX_BLOCK_SIZE: usize = 65271; // Максимальный размер блока - 65251 байта, т.к. максимальный размер нагрузки UDP пакета - 65535 байт, из которых вычитаем 256 байт хэша и 8 байт заголовков
